...
export async function GET(request: NextRequest) {
  ...
  const params = url.pathname.replace('/api/auth/', '');  // yeh theek hai

  // Sahi path: /api/auth/ ko backend pe bhi /api/auth/ bhejna hai
  const backendUrl = `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/auth/${params}`;
