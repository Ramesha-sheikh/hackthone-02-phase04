      ...
      <main className="container mx-auto px-4 relative z-10">
        ...
        <section className="text-center py-20 md:py-32">
          ...
          <p className="text-xl md:text-2xl text-[color:var(--text-secondary)] max-w-3xl mx-auto mb-10">
            We're a team of passionate developers and designers creating the future of task management with a coffee-inspired twist.
          </p>
          <div className="flex justify-center gap-4">
            <Link href="/" className="coffee-button-primary text-lg px-8 py-4">
              Back to Home <MoveRight className="ml-2" />
            </Link>
            <Link href="/signup" className="coffee-button-secondary text-lg px-8 py-4">
              Join Us
            </Link>
          </div>
        </section>
        ...
        <section className="py-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="coffee-card p-6 text-center hover:transform hover:scale-105 transition-all duration-300">
            ...
            {teamMembers.map((member, index) => (
              <div key={index} className="coffee-card p-6 text-center hover:transform hover:scale-105 transition-all duration-300">
                <img
                  src={member.avatar}
                  alt={member.name}
                  className="w-24 h-24 rounded-full mx-auto mb-4 border-2 border-[color:var(--accent-coffee)]"
                />
                <h3 className="text-xl font-bold mb-1 text-[color:var(--text-primary)]">{member.name}</h3>
                <p className="text-[color:var(--accent-caramel)] mb-3">{member.role}</p>
        ...
        <section className="py-20">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                <h3 className="text-2xl font-bold mb-4 text-[color:var(--accent-coffee)]">Design First</h3>
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 text-[color:var(--accent-caramel)]">User Focused</h3>
                <p className="text-[color:var(--text-secondary)]">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 text-[color:var(--accent-coffee)]">Innovation Driven</h3>
                <p className="text-[color:var(--text-secondary)]">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 text-[color:var(--accent-caramel)]">Security Conscious</h3>
                <p className="text-[color:var(--text-secondary)]">
        ...
        <section className="text-center py-20">
          ...
          <p className="text-xl text-[color:var(--text-secondary)] mb-10 max-w-2xl mx-auto">
            Join thousands of forward-thinking individuals who have revolutionized their task management with Coffee Todo.
          </p>
          <Link href="/signup" className="coffee-button-primary text-2xl px-12 py-5">
