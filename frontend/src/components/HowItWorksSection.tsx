    ...
    <section className="py-20">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
        {howItWorks.map((step, index) => (
          <div key={index} className="coffee-card p-6 text-center">
            <div className="w-12 h-12 rounded-full bg-[color:var(--accent-coffee)] text-[color:var(--bg-card)] flex items-center justify-center text-xl font-bold mx-auto mb-4">
              {step.step}
            </div>
