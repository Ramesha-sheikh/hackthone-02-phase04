...
export default function FAQItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div className="border-b border-[color:var(--border-coffee)] py-4 transition-all duration-300">
      <button
      ...
      >
        ...
        <ChevronDown
          className={`transform transition-transform duration-300 text-[color:var(--accent-coffee)] ${
            isOpen ? "rotate-180" : ""
          }`}
        />
      </button>
